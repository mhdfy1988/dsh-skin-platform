...
pnpm.cmd dsh plugin --profile web add "$SkinRepo\artifacts\dsh-skin-dream-journey-$Version.tgz"
```
...
本皮肤固定使用浅色方案，并对正文、代码块、轨迹标签、下拉菜单和设置卡片保持高对比度。切换到“Harness 默认”后，Harness 自带外观设置会重新生效。
