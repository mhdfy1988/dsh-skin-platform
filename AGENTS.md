...
13. A user-selected background is profile-local data at `<DSH_HOME>/skin-runtime/user-background`; never copy it into a skin package or publish it with an artifact.
